...
801009cb:	0f 84 b0 01 00 00    	je     80100b81 <exec+0x1e1>
    end_op();
    cprintf("exec: fail\n");
    return -1;
  }
...
80100b67:	75 33                	jne    80100b9c <exec+0x1fc>
    freevm(pgdir);
80100b69:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100b6f:	89 04 24             	mov    %eax,(%esp)
80100b72:	e8 69 5e 00 00       	call   801069e0 <freevm>
  return -1;
80100b77:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100b7c:	e9 91 fe ff ff       	jmp    80100a12 <exec+0x72>
    end_op();
80100b81:	e8 fa 1f 00 00       	call   80102b80 <end_op>
    cprintf("exec: fail\n");
80100b86:	c7 04 24 e1 6e 10 80 	movl   $0x80106ee1,(%esp)
80100b8d:	e8 be fa ff ff       	call   80100650 <cprintf>
    return -1;
80100b92:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100b97:	e9 76 fe ff ff       	jmp    80100a12 <exec+0x72>
  curproc->mypages = 1;											 // Lab3
80100b9c:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100ba2:	c7 40 7c 01 00 00 00 	movl   $0x1,0x7c(%eax)
  cprintf("Initial number of pages by the process:%d\n",myproc()->mypages);
80100ba9:	e8 f2 2a 00 00       	call   801036a0 <myproc>
80100bae:	8b 40 7c             	mov    0x7c(%eax),%eax
80100bb1:	c7 04 24 f0 6e 10 80 	movl   $0x80106ef0,(%esp)
80100bb8:	89 44 24 04          	mov    %eax,0x4(%esp)
80100bbc:	e8 8f fa ff ff       	call   80100650 <cprintf>
  for(argc = 0; argv[argc]; argc++) {
80100bc1:	8b 45 0c             	mov    0xc(%ebp),%eax
80100bc4:	8b 00                	mov    (%eax),%eax
80100bc6:	85 c0                	test   %eax,%eax
80100bc8:	0f 84 61 01 00 00    	je     80100d2f <exec+0x38f>
80100bce:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80100bd1:	31 d2                	xor    %edx,%edx
80100bd3:	8d 71 04             	lea    0x4(%ecx),%esi
80100bd6:	89 cf                	mov    %ecx,%edi
80100bd8:	89 d1                	mov    %edx,%ecx
80100bda:	89 f2                	mov    %esi,%edx
80100bdc:	89 fe                	mov    %edi,%esi
80100bde:	89 cf                	mov    %ecx,%edi
80100be0:	eb 12                	jmp    80100bf4 <exec+0x254>
80100be2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80100be8:	83 c2 04             	add    $0x4,%edx
    if(argc >= MAXARG)
80100beb:	83 ff 20             	cmp    $0x20,%edi
80100bee:	0f 84 75 ff ff ff    	je     80100b69 <exec+0x1c9>
    sp = (sp - (strlen(argv[argc]) + 1)) & ~3;
80100bf4:	89 04 24             	mov    %eax,(%esp)
80100bf7:	89 95 e8 fe ff ff    	mov    %edx,-0x118(%ebp)
80100bfd:	e8 9e 38 00 00       	call   801044a0 <strlen>
...
80100c0e:	e8 8d 38 00 00       	call   801044a0 <strlen>
...
80100c2d:	e8 0e 61 00 00       	call   80106d40 <copyout>
80100c32:	85 c0                	test   %eax,%eax
80100c34:	0f 88 2f ff ff ff    	js     80100b69 <exec+0x1c9>
  for(argc = 0; argv[argc]; argc++) {
...
80100c9a:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca0:	e8 9b 60 00 00       	call   80106d40 <copyout>
80100ca5:	85 c0                	test   %eax,%eax
80100ca7:	0f 88 bc fe ff ff    	js     80100b69 <exec+0x1c9>
  for(last=s=path; *s; s++)
...
80100ced:	e8 6e 37 00 00       	call   80104460 <safestrcpy>
  curproc->pgdir = pgdir;
80100cf2:	8b 8d f0 fe ff ff    	mov    -0x110(%ebp),%ecx
  oldpgdir = curproc->pgdir;
80100cf8:	8b 77 04             	mov    0x4(%edi),%esi
  curproc->tf->eip = elf.entry;  // main
80100cfb:	8b 47 18             	mov    0x18(%edi),%eax
  curproc->pgdir = pgdir;
80100cfe:	89 4f 04             	mov    %ecx,0x4(%edi)
  curproc->sz = sz;
80100d01:	8b 8d ec fe ff ff    	mov    -0x114(%ebp),%ecx
80100d07:	89 0f                	mov    %ecx,(%edi)
  curproc->tf->eip = elf.entry;  // main
80100d09:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d0f:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d12:	8b 47 18             	mov    0x18(%edi),%eax
80100d15:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100d18:	89 3c 24             	mov    %edi,(%esp)
80100d1b:	e8 40 59 00 00       	call   80106660 <switchuvm>
  freevm(oldpgdir);
80100d20:	89 34 24             	mov    %esi,(%esp)
80100d23:	e8 b8 5c 00 00       	call   801069e0 <freevm>
  return 0;
80100d28:	31 c0                	xor    %eax,%eax
80100d2a:	e9 e3 fc ff ff       	jmp    80100a12 <exec+0x72>
  for(argc = 0; argv[argc]; argc++) {
80100d2f:	31 d2                	xor    %edx,%edx
80100d31:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
80100d37:	e9 1e ff ff ff       	jmp    80100c5a <exec+0x2ba>
...
80100d46:	c7 44 24 04 1b 6f 10 	movl   $0x80106f1b,0x4(%esp)
80100d4d:	80 
...
80100e06:	c3                   	ret    
    panic("filedup");
80100e07:	c7 04 24 22 6f 10 80 	movl   $0x80106f22,(%esp)
...
80100ec7:	e9 b4 1c 00 00       	jmp    80102b80 <end_op>
    panic("fileclose");
80100ecc:	c7 04 24 2a 6f 10 80 	movl   $0x80106f2a,(%esp)
...
80100fb5:	eb d8                	jmp    80100f8f <fileread+0x5f>
  panic("fileread");
80100fb7:	c7 04 24 34 6f 10 80 	movl   $0x80106f34,(%esp)
...
801010cc:	e9 1f 22 00 00       	jmp    801032f0 <pipewrite>
        panic("short filewrite");
801010d1:	c7 04 24 3d 6f 10 80 	movl   $0x80106f3d,(%esp)
801010d8:	e8 83 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010dd:	c7 04 24 43 6f 10 80 	movl   $0x80106f43,(%esp)
...
80101195:	c7 04 24 4d 6f 10 80 	movl   $0x80106f4d,(%esp)
...
801012bd:	c7 04 24 63 6f 10 80 	movl   $0x80106f63,(%esp)
...
80101375:	eb 93                	jmp    8010130a <bmap+0x3a>
  panic("bmap: out of range");
80101377:	c7 04 24 73 6f 10 80 	movl   $0x80106f73,(%esp)
...
80101459:	c7 04 24 86 6f 10 80 	movl   $0x80106f86,(%esp)
...
8010147c:	c7 44 24 04 99 6f 10 	movl   $0x80106f99,0x4(%esp)
80101483:	80 
...
80101499:	c7 44 24 04 a0 6f 10 	movl   $0x80106fa0,0x4(%esp)
801014a0:	80 
...
801015e1:	c7 04 24 a6 6f 10 80 	movl   $0x80106fa6,(%esp)
...
80101764:	0f 85 76 ff ff ff    	jne    801016e0 <ilock+0x30>
      panic("ilock: no type");
8010176a:	c7 04 24 be 6f 10 80 	movl   $0x80106fbe,(%esp)
80101771:	e8 ea eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101776:	c7 04 24 b8 6f 10 80 	movl   $0x80106fb8,(%esp)
...
801017be:	e9 1d 28 00 00       	jmp    80103fe0 <releasesleep>
    panic("iunlock");
801017c3:	c7 04 24 cd 6f 10 80 	movl   $0x80106fcd,(%esp)
...
80101c61:	c3                   	ret    
      panic("dirlookup read");
80101c62:	c7 04 24 e7 6f 10 80 	movl   $0x80106fe7,(%esp)
80101c69:	e8 f2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c6e:	c7 04 24 d5 6f 10 80 	movl   $0x80106fd5,(%esp)
...
80101ee3:	eb e9                	jmp    80101ece <dirlink+0xae>
      panic("dirlink read");
80101ee5:	c7 04 24 f6 6f 10 80 	movl   $0x80106ff6,(%esp)
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 65 38 00 00       	call   80106640 <switchkvm>
  seginit();
...
80102e3a:	e8 61 2a 00 00       	call   801058a0 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
...
80103705:	80 
80103706:	e8 65 30 00 00       	call   80106770 <inituvm>
  p->sz = PGSIZE;
...
80103809:	e8 b2 30 00 00       	call   801068c0 <allocuvm>
...
80103817:	e8 44 2e 00 00       	call   80106660 <switchuvm>
  return 0;
...
801039b2:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039b5:	e8 a6 2c 00 00       	call   80106660 <switchuvm>
...
801039cb:	e8 eb 0a 00 00       	call   801044bb <swtch>
      switchkvm();
801039d0:	e8 6b 2c 00 00       	call   80106640 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103d38:	e8 a3 2c 00 00       	call   801069e0 <freevm>
        release(&ptable.lock);
...
80105522:	0f 84 20 02 00 00    	je     80105748 <trap+0x238>
    if(myproc()->killed)
      exit();
    return;
  }
...
8010553f:	90                   	nop
80105540:	0f 84 9c 02 00 00    	je     801057e2 <trap+0x2d2>
80105546:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010554a:	0f 84 92 02 00 00    	je     801057e2 <trap+0x2d2>
...
8010560b:	0f 84 68 01 00 00    	je     80105779 <trap+0x269>
    exit();
}
...
80105655:	be fe 0f 00 80       	mov    $0x80000ffe,%esi
8010565a:	8b 40 7c             	mov    0x7c(%eax),%eax
8010565d:	c1 e0 0c             	shl    $0xc,%eax
80105660:	29 c6                	sub    %eax,%esi
80105662:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80105668:	89 35 60 4d 11 80    	mov    %esi,0x80114d60
8010566e:	0f 20 d0             	mov    %cr2,%eax
	if(rcr2() < StackEnd){
80105671:	39 c6                	cmp    %eax,%esi
80105673:	0f 86 47 ff ff ff    	jbe    801055c0 <trap+0xb0>
		if(allocuvm(myproc()->pgdir, StackEnd-PGSIZE, StackEnd)==0){
80105679:	e8 22 e0 ff ff       	call   801036a0 <myproc>
8010567e:	89 74 24 08          	mov    %esi,0x8(%esp)
80105682:	81 ee 00 10 00 00    	sub    $0x1000,%esi
80105688:	89 74 24 04          	mov    %esi,0x4(%esp)
8010568c:	8b 40 04             	mov    0x4(%eax),%eax
8010568f:	89 04 24             	mov    %eax,(%esp)
80105692:	e8 29 12 00 00       	call   801068c0 <allocuvm>
80105697:	85 c0                	test   %eax,%eax
80105699:	0f 84 21 01 00 00    	je     801057c0 <trap+0x2b0>
		myproc()->mypages += 1;
8010569f:	e8 fc df ff ff       	call   801036a0 <myproc>
801056a4:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
...
801056ad:	8b 40 7c             	mov    0x7c(%eax),%eax
801056b0:	c7 04 24 a4 76 10 80 	movl   $0x801076a4,(%esp)
801056b7:	89 44 24 04          	mov    %eax,0x4(%esp)
801056bb:	e8 90 af ff ff       	call   80100650 <cprintf>
801056c0:	e9 fb fe ff ff       	jmp    801055c0 <trap+0xb0>
801056c5:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
801056c8:	e8 b3 df ff ff       	call   80103680 <cpuid>
801056cd:	85 c0                	test   %eax,%eax
801056cf:	90                   	nop
801056d0:	0f 84 ba 00 00 00    	je     80105790 <trap+0x280>
    lapiceoi();
801056d6:	e8 a5 d0 ff ff       	call   80102780 <lapiceoi>
801056db:	90                   	nop
801056dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    break;
801056e0:	e9 db fe ff ff       	jmp    801055c0 <trap+0xb0>
801056e5:	8d 76 00             	lea    0x0(%esi),%esi
801056e8:	90                   	nop
801056e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801056f0:	e8 db ce ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
801056f5:	e8 86 d0 ff ff       	call   80102780 <lapiceoi>
    break;
801056fa:	e9 c1 fe ff ff       	jmp    801055c0 <trap+0xb0>
801056ff:	90                   	nop
    uartintr();
80105700:	e8 3b 02 00 00       	call   80105940 <uartintr>
    lapiceoi();
...
80105717:	e8 64 df ff ff       	call   80103680 <cpuid>
8010571c:	c7 04 24 2c 76 10 80 	movl   $0x8010762c,(%esp)
...
80105734:	e8 47 d0 ff ff       	call   80102780 <lapiceoi>
    break;
80105739:	e9 82 fe ff ff       	jmp    801055c0 <trap+0xb0>
8010573e:	66 90                	xchg   %ax,%ax
    ideintr();
80105740:	e8 3b c9 ff ff       	call   80102080 <ideintr>
80105745:	eb 8f                	jmp    801056d6 <trap+0x1c6>
80105747:	90                   	nop
80105748:	90                   	nop
...
8010575a:	75 2c                	jne    80105788 <trap+0x278>
    myproc()->tf = tf;
8010575c:	e8 3f df ff ff       	call   801036a0 <myproc>
80105761:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105764:	e8 b7 ee ff ff       	call   80104620 <syscall>
    if(myproc()->killed)
80105769:	e8 32 df ff ff       	call   801036a0 <myproc>
8010576e:	8b 48 24             	mov    0x24(%eax),%ecx
80105771:	85 c9                	test   %ecx,%ecx
80105773:	0f 84 98 fe ff ff    	je     80105611 <trap+0x101>
}
...
8010577f:	5d                   	pop    %ebp
      exit();
80105780:	e9 1b e3 ff ff       	jmp    80103aa0 <exit>
80105785:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105788:	e8 13 e3 ff ff       	call   80103aa0 <exit>
8010578d:	eb cd                	jmp    8010575c <trap+0x24c>
8010578f:	90                   	nop
      acquire(&tickslock);
80105790:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
80105797:	e8 a4 e9 ff ff       	call   80104140 <acquire>
      wakeup(&ticks);
8010579c:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
      ticks++;
801057a3:	83 05 c0 55 11 80 01 	addl   $0x1,0x801155c0
      wakeup(&ticks);
801057aa:	e8 e1 e5 ff ff       	call   80103d90 <wakeup>
      release(&tickslock);
801057af:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
801057b6:	e8 75 ea ff ff       	call   80104230 <release>
801057bb:	e9 16 ff ff ff       	jmp    801056d6 <trap+0x1c6>
...
801057c8:	c7 04 24 50 76 10 80 	movl   $0x80107650,(%esp)
801057cf:	89 44 24 04          	mov    %eax,0x4(%esp)
801057d3:	e8 78 ae ff ff       	call   80100650 <cprintf>
			exit();
801057d8:	e8 c3 e2 ff ff       	call   80103aa0 <exit>
801057dd:	e9 bd fe ff ff       	jmp    8010569f <trap+0x18f>
801057e2:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801057e5:	8b 73 38             	mov    0x38(%ebx),%esi
801057e8:	e8 93 de ff ff       	call   80103680 <cpuid>
801057ed:	89 7c 24 10          	mov    %edi,0x10(%esp)
801057f1:	89 74 24 0c          	mov    %esi,0xc(%esp)
801057f5:	89 44 24 08          	mov    %eax,0x8(%esp)
801057f9:	8b 43 30             	mov    0x30(%ebx),%eax
801057fc:	c7 04 24 f4 76 10 80 	movl   $0x801076f4,(%esp)
80105803:	89 44 24 04          	mov    %eax,0x4(%esp)
80105807:	e8 44 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
8010580c:	c7 04 24 26 76 10 80 	movl   $0x80107626,(%esp)
80105813:	e8 48 ab ff ff       	call   80100360 <panic>
...
80105877:	e8 24 cf ff ff       	call   801027a0 <microdelay>
...
80105907:	00 
  for(p="xv6...\n"; *p; p++)
80105908:	bb 34 78 10 80       	mov    $0x80107834,%ebx
  ioapicenable(IRQ_COM1, 0);
8010590d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105914:	e8 97 c9 ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80106414:	e8 87 c0 ff ff       	call   801024a0 <kalloc>
...
80106432:	e8 49 de ff ff       	call   80104280 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801064ea:	c3                   	ret    
        panic("kfree");
801064eb:	c7 04 24 f2 70 10 80 	movl   $0x801070f2,(%esp)
...
80106631:	c3                   	ret    
      panic("remap");
80106632:	c7 04 24 3c 78 10 80 	movl   $0x8010783c,(%esp)
80106639:	e8 22 9d ff ff       	call   80100360 <panic>
8010663e:	66 90                	xchg   %ax,%ax

80106640 <switchkvm>:
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80106640:	a1 c4 55 11 80       	mov    0x801155c4,%eax
{
...
80106684:	0f 84 c3 00 00 00    	je     8010674d <switchuvm+0xed>
  pushcli();
8010668a:	e8 71 da ff ff       	call   80104100 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010668f:	e8 6c cf ff ff       	call   80103600 <mycpu>
80106694:	89 c3                	mov    %eax,%ebx
80106696:	e8 65 cf ff ff       	call   80103600 <mycpu>
8010669b:	89 c7                	mov    %eax,%edi
8010669d:	e8 5e cf ff ff       	call   80103600 <mycpu>
...
8010673b:	5d                   	pop    %ebp
  popcli();
8010673c:	e9 7f da ff ff       	jmp    801041c0 <popcli>
    panic("switchuvm: no process");
80106741:	c7 04 24 42 78 10 80 	movl   $0x80107842,(%esp)
80106748:	e8 13 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010674d:	c7 04 24 6d 78 10 80 	movl   $0x8010786d,(%esp)
80106754:	e8 07 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106759:	c7 04 24 58 78 10 80 	movl   $0x80107858,(%esp)
...
8010678a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
8010678d:	e8 0e bd ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
...
801067a5:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801067a7:	e8 d4 da ff ff       	call   80104280 <memset>
...
801067e8:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801067e9:	e9 32 db ff ff       	jmp    80104320 <memmove>
    panic("inituvm: more than a page");
801067ee:	c7 04 24 81 78 10 80 	movl   $0x80107881,(%esp)
...
8010687d:	e8 de b0 ff ff       	call   80101960 <readi>
...
801068a2:	c7 04 24 9b 78 10 80 	movl   $0x8010789b,(%esp)
801068a9:	e8 b2 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
801068ae:	c7 04 24 3c 79 10 80 	movl   $0x8010793c,(%esp)
...
8010690b:	e8 70 d9 ff ff       	call   80104280 <memset>
...
80106945:	76 29                	jbe    80106970 <allocuvm+0xb0>
    mem = kalloc();
80106947:	e8 54 bb ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
...
80106952:	c7 04 24 b9 78 10 80 	movl   $0x801078b9,(%esp)
...
80106980:	c7 04 24 d1 78 10 80 	movl   $0x801078d1,(%esp)
...
80106a43:	e9 a8 b8 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106a48:	c7 04 24 ed 78 10 80 	movl   $0x801078ed,(%esp)
...
80106a8b:	e8 f0 d7 ff ff       	call   80104280 <memset>
...
80106afb:	a3 c4 55 11 80       	mov    %eax,0x801155c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106b2b:	c3                   	ret    
    panic("clearpteu");
80106b2c:	c7 04 24 fe 78 10 80 	movl   $0x801078fe,(%esp)
...
80106b53:	0f 84 81 01 00 00    	je     80106cda <copyuvm+0x19a>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106b7d:	e8 9e d7 ff ff       	call   80104320 <memmove>
...
80106bc7:	0f 84 20 01 00 00    	je     80106ced <copyuvm+0x1ad>
    if(!(*pte & PTE_P))
80106bcd:	8b 30                	mov    (%eax),%esi
80106bcf:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106bd5:	0f 84 06 01 00 00    	je     80106ce1 <copyuvm+0x1a1>
    pa = PTE_ADDR(*pte);
...
80106be6:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106bec:	e8 af b8 ff ff       	call   801024a0 <kalloc>
...
80106c0f:	c3                   	ret    
  StackEnd = PGROUNDUP(STACKTOP - myproc()->mypages * PGSIZE);
80106c10:	e8 8b ca ff ff       	call   801036a0 <myproc>
80106c15:	bb fe 0f 00 80       	mov    $0x80000ffe,%ebx
80106c1a:	8b 40 7c             	mov    0x7c(%eax),%eax
80106c1d:	c1 e0 0c             	shl    $0xc,%eax
80106c20:	29 c3                	sub    %eax,%ebx
80106c22:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(i = StackEnd; i < STACKTOP; i += PGSIZE) {
80106c28:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80106c2e:	76 60                	jbe    80106c90 <copyuvm+0x150>
80106c30:	e9 9a 00 00 00       	jmp    80106ccf <copyuvm+0x18f>
...
80106c75:	e8 46 f9 ff ff       	call   801065c0 <mappages>
80106c7a:	85 c0                	test   %eax,%eax
80106c7c:	0f 88 79 ff ff ff    	js     80106bfb <copyuvm+0xbb>
  for(i = StackEnd; i < STACKTOP; i += PGSIZE) {
80106c82:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c88:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80106c8e:	77 3f                	ja     80106ccf <copyuvm+0x18f>
	if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106c90:	8b 45 08             	mov    0x8(%ebp),%eax
80106c93:	31 c9                	xor    %ecx,%ecx
80106c95:	89 da                	mov    %ebx,%edx
80106c97:	e8 34 f7 ff ff       	call   801063d0 <walkpgdir>
80106c9c:	85 c0                	test   %eax,%eax
80106c9e:	74 4d                	je     80106ced <copyuvm+0x1ad>
    if(!(*pte & PTE_P))
80106ca0:	8b 30                	mov    (%eax),%esi
80106ca2:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106ca8:	74 37                	je     80106ce1 <copyuvm+0x1a1>
    pa = PTE_ADDR(*pte);
...
80106cc4:	0f 85 6e ff ff ff    	jne    80106c38 <copyuvm+0xf8>
80106cca:	e9 2c ff ff ff       	jmp    80106bfb <copyuvm+0xbb>
80106ccf:	8b 45 e0             	mov    -0x20(%ebp),%eax
}
80106cd2:	83 c4 2c             	add    $0x2c,%esp
80106cd5:	5b                   	pop    %ebx
80106cd6:	5e                   	pop    %esi
80106cd7:	5f                   	pop    %edi
80106cd8:	5d                   	pop    %ebp
80106cd9:	c3                   	ret    
    return 0;
80106cda:	31 c0                	xor    %eax,%eax
80106cdc:	e9 27 ff ff ff       	jmp    80106c08 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106ce1:	c7 04 24 22 79 10 80 	movl   $0x80107922,(%esp)
80106ce8:	e8 73 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106ced:	c7 04 24 08 79 10 80 	movl   $0x80107908,(%esp)
80106cf4:	e8 67 96 ff ff       	call   80100360 <panic>
...
80106d0e:	e8 bd f6 ff ff       	call   801063d0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106ddd:	80 
80106dde:	c7 04 24 e0 55 11 80 	movl   $0x801155e0,(%esp)
80106de5:	e8 66 d2 ff ff       	call   80104050 <initlock>
  acquire(&(shm_table.lock));
80106dea:	c7 04 24 e0 55 11 80 	movl   $0x801155e0,(%esp)
80106df1:	e8 4a d3 ff ff       	call   80104140 <acquire>
80106df6:	b8 14 56 11 80       	mov    $0x80115614,%eax
80106dfb:	90                   	nop
...
80106e10:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for (i = 0; i< 64; i++) {
80106e17:	3d 14 59 11 80       	cmp    $0x80115914,%eax
80106e1c:	75 e2                	jne    80106e00 <shminit+0x30>
  }
  release(&(shm_table.lock));
80106e1e:	c7 04 24 e0 55 11 80 	movl   $0x801155e0,(%esp)
